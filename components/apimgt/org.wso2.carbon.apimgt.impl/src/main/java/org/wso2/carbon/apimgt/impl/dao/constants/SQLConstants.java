...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_LLM_PROVIDER_CONFIGURATIONS_SQL =
            "SELECT UUID, CONFIGURATIONS " +
                    "FROM AM_LLM_PROVIDERS";

    public static final String GET_INBUILT_LLM_PROVIDER_CONFIGURATIONS_BY_ORG_SQL =
            "SELECT CONFIGURATIONS FROM AM_LLM_PROVIDERS WHERE ORGANIZATION = ? AND BUILT_IN_SUPPORT = true";
    ...
    public static final String DELETE_LLM_PROVIDERS_SQL =
            "DELETE FROM AM_LLM_PROVIDERS " +
                    "WHERE ORGANIZATION = ? AND UUID = ? AND IN_BUILT_SUPPORT = false";

    public static final String UPDATE_LLM_PROVIDERS_SQL =
            "UPDATE AM_LLM_PROVIDERS SET DESCRIPTION = ?, API_DEFINITION = ?, CONFIGURATIONS = ? " +
                    "WHERE ORGANIZATION = ? AND UUID = ? AND IN_BUILT_SUPPORT = false";

    public static final String UPDATE_IN_BUILT_LLM_PROVIDERS_SQL = "UPDATE AM_LLM_PROVIDERS SET API_DEFINITION = ? WHERE ORGANIZATION = ? AND UUID = ?";;
    ...
    public static final String CHECK_LLM_PROVIDER_BUILT_IN_SUPPORT_SQL = "SELECT IN_BUILT_SUPPORT FROM AM_LLM_PROVIDERS WHERE ORGANIZATION = ? AND UUID = ?";
