...
public enum ExceptionCodes implements ErrorHandler {
    ...
    MCP_SERVER_NOT_FOUND(900806, "MCP Server Not Found", 404,
            "Requested MCP Server with id '%s' not found"),
    MCP_SERVER_REVISION_NOT_FOUND(900807, "MCP Server Revision Not Found", 404,
            "Requested MCP Server Revision with id %s not found"),
    MCP_SERVER_VERSION_ALREADY_EXISTS(900808, "The MCP Server version already exists.", 409,
            "A MCP Server with version '%s' already exists for MCP Server '%s'"),
    RETIRED_MCP_SERVER_REVISION_DEPLOYMENT_UNSUPPORTED(903227,
    ...
    NO_MCP_SERVER_ARTIFACT_FOUND(900910, "No MCP Server artifacts found for given criteria", 404,
            "No MCP Server artifacts found for given criteria"),
    MCP_SERVER_UPDATE_FORBIDDEN_PER_LC(900380, "Insufficient permission to update the MCP Server", 403,
            "Updating the MCP Server is restricted as as it is %s."),
    INVALID_MCP_SERVER_ID(902006, "Invalid MCP Server ID", 404,
