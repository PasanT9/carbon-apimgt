...
public interface APIAdmin  {
     ...
     */
    String deleteLlmProvider(String organization, String llmProviderId) throws APIManagementException;
    ...
    List<String> getInBuiltPayloadHandlers(String organization) throws APIManagementException;
}
