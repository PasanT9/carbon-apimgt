...
LlmProvidersApiService delegate = new LlmProvidersApiServiceImpl();
    ...
    @ApiOperation(value = "Get all LLM providers", notes = "Get all LLM providers ", response = LLMProviderSummaryResponseListDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "apim:llm_provider_view", description = "View LLM providers")
        })
    }, tags={ "LLMProviders" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK. List of LLM providers is returned. ", response = LLMProviderSummaryResponseListDTO.class),
