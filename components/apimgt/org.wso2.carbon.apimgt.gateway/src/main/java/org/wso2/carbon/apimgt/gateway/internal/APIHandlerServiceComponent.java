...
public class APIHandlerServiceComponent {
    ...
    protected void addLlmPayloadHandler(LlmProviderService llmProviderService) {
        ...
        ServiceReferenceHolder.getInstance().addLlmPayloadHandler(llmProviderService.getType(), llmProviderService);
    }

    protected void removeLlmPayloadHandler(LlmProviderService llmProviderService) {

        ServiceReferenceHolder.getInstance().removeLlmPayloadHandler(llmProviderService.getType());
    }
