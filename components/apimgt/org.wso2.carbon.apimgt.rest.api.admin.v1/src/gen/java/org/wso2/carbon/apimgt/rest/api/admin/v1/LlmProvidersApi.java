...
LlmProvidersApiService delegate = new LlmProvidersApiServiceImpl();
    ...
    public Response addLlmProvider(@Multipart(value = "name")  String name, @Multipart(value = "id", required = false)  String id, @Multipart(value = "version", required = false)  String version, @Multipart(value = "headers", required = false)  List<String> headers, @Multipart(value = "queryParams", required = false)  List<String> queryParams, @Multipart(value = "description", required = false)  String description,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "modelPath", required = false)  String modelPath, @Multipart(value = "totalTokensPath", required = false)  String totalTokensPath, @Multipart(value = "requestTokensPath", required = false)  String requestTokensPath, @Multipart(value = "responseTokensPath", required = false)  String responseTokensPath) throws APIManagementException{
        return delegate.addLlmProvider(name, id, version, headers, queryParams, description, apiDefinitionInputStream, apiDefinitionDetail, modelPath, totalTokensPath, requestTokensPath, responseTokensPath, securityContext);
    }
    ...
    public Response getAllLlmProviders() throws APIManagementException{
        return delegate.getAllLlmProviders(securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Bad Request. Invalid request or validation error.", response = ErrorDTO.class),
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class) })
    public Response updateLlmProvider(@ApiParam(value = "LLM Provider UUID ",required=true) @PathParam("llmProviderId") String llmProviderId, @Multipart(value = "name")  String name, @Multipart(value = "id", required = false)  String id, @Multipart(value = "version", required = false)  String version, @Multipart(value = "headers", required = false)  List<String> headers, @Multipart(value = "queryParams", required = false)  List<String> queryParams, @Multipart(value = "description", required = false)  String description,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "modelPath", required = false)  String modelPath, @Multipart(value = "totalTokensPath", required = false)  String totalTokensPath, @Multipart(value = "requestTokensPath", required = false)  String requestTokensPath, @Multipart(value = "responseTokensPath", required = false)  String responseTokensPath) throws APIManagementException{
        return delegate.updateLlmProvider(llmProviderId, name, id, version, headers, queryParams, description, apiDefinitionInputStream, apiDefinitionDetail, modelPath, totalTokensPath, requestTokensPath, responseTokensPath, securityContext);
    }
}
